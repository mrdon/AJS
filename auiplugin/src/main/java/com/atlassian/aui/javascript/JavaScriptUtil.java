...
public class JavaScriptUtil
{
    ...
    /**
     * <p> Escapes the characters in a <code>String</code> using JavaScript String rules. </p> <p> Escapes any values it
     * finds into their JavaScript String form. Deals correctly with quotes and control-chars (tab, backslash, cr, ff,
     * etc.) </p>
     * <p/>
     * <p> So a tab becomes the characters <code>'\\'</code> and <code>'t'</code>. </p>
     * <p/>
     * <p> The only difference between Java strings and JavaScript strings is that in JavaScript, a single quote must be
     * escaped. </p>
     * <p/>
     * <p> Example:
     * <p/>
