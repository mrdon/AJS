                ...
                if (supportsTouch) {
                    for (var i = 0, ii = e.touches.length; i < ii; i++) {
                        ...
                        if (touch.identifier == el._drag.id) {
                            onmove && onmove.call(el, touch.clientX - el._drag.x, touch.clientY - el._drag.y);
                            e.preventDefault();
                            break;
                        }
                    }
                } else {
                    onmove && onmove.call(el, e.clientX - el._drag.x, e.clientY - el._drag.y);
                    e.preventDefault();
                }
            },
            up = function (e) {
