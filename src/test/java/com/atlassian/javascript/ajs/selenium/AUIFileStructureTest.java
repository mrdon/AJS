...
public class AUIFileStructureTest
{
    private static final String[] PROJ_STRUCTURE = new String[]{
        ...
        // If you're adding files here, make you've added them to all sample and test pages too!
            ...
            "css/atlassian/dialog-ie.css",
            "css/atlassian/dropdown-ie.css",
            "css/atlassian/forms-ie.css",
            "css/atlassian/icons-ie.css",
            "css/atlassian/inline-dialog-ie.css",
            ...
            "css/atlassian/images/bg-000-trans50.png",
            "css/atlassian/images/bg-000-trans20.png",       
