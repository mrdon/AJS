...
public class TestContextPathTransformer extends TestCase {
    ...
    public void testWithContext() throws Exception
    {
        ...
        String result = transform("    var AJS_SUBSTITUTE_CONTEXT_PATH_HERE = false;");
        assertEquals("    var AJS_SUBSTITUTE_CONTEXT_PATH_HERE = \"\\/jira\";", result);
    }
    public void testEmptyContext() throws Exception
    {
        ...
        String result = transform("    var AJS_SUBSTITUTE_CONTEXT_PATH_HERE = false;");
        assertEquals("    var AJS_SUBSTITUTE_CONTEXT_PATH_HERE = \"\";", result);
    }
