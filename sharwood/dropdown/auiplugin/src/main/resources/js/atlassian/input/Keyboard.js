 ...
 *
 * Listen to AJS.Keyboard.SpecialKey.eventType() for special keys and
...
(function ($) {
     ...
     */
    AJS.Keyboard.characterEntered = function (keypressEvent) {
     ...
     */
    AJS.Keyboard.specialKeyEntered = function (e) {
        e = originalEvent(e);
        if ($.browser.mozilla) {
     ...
     *
     * @param {Event} e a AJS.Keyboard.SpecialKey.eventType() event
     * @return {string|undefined} shortcut entered, of the form
     *   /(alt|ctrl|meta|shift)\+)*(key)/, or undefined if no shortcut entered.
     */
    AJS.Keyboard.shortcutEntered = function (e) {
        e = originalEvent(e);
        if (e.type === AJS.Keyboard.SpecialKey.eventType()) {
            var specialKey = AJS.Keyboard.specialKeyEntered(e),
                modifiers = '';
